                    ...
                    <Grid container spacing={2} justifyContent="center" sx={{ mb: 3 }}>
                        ...
                        <Grid item>
                            ...
                            >
                                ...
                                <Typography variant="h6" fontWeight={700}>Accepted GR List</Typography>
                            </Card>
                        </Grid>
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={12} md={12}>
                                        {/* <Paper sx={{ p: 2, mb: 2,backgroundColor:"#e3f2fd" }}>
                                            <Typography variant="h5" align="center" sx={{ mb: 2, fontWeight: 'bold', fontFamily: 'Times New Roman', color: 'black' }}>
                                        ...
                                        <Paper sx={{ p: 2, mb: 2, background:"#e3f2fd" }}>
                                            ...
                                            <Grid container spacing={2} sx={{ width: "100%", mx: "auto", py: 2}}>
                                                ...
                                                <Grid item xs={12}>
                                                    ...
                                                    <Stack direction="row" spacing={4}  sx={{ ml: "10rem" }}>
                                                        {/* Category */}
                                                        <TextField
                                                            select
                                                            label="Category"
...
<Grid item xs={12}>
  ...
  >
    ...
    <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
      <Typography>Qty Received:</Typography>
      <Typography sx={{ fontWeight: 700 }}>{form.totalQty}</Typography>
    </Box>

    {/* Qty Inspected = accepted + rejected */}
    <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
      <Typography>Qty Inspected:</Typography>
      <TextField
        variant="standard"
